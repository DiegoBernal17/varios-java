...
public class Vampire extends Applet {
	...
	public void paint(Graphics g)
	{
		...
		g.fillOval(posi_x+92, posi_y+148, 20, 20);
		g.fillOval(posi_x+142, posi_y+148, 20, 20);
		g.setColor(Color.decode("#301A06"));
		g.fillOval(posi_x+97, posi_y+154, 10, 10);
		g.fillOval(posi_x+147, posi_y+154, 10, 10);
