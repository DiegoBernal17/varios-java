...
public class Practica11 extends Applet implements Runnable {

	private int posi_x, posi_y;
	private boolean move;
	private int avanzar;
	
	public Practica11(int x, int y)
	{
		posi_x = x-80;
		posi_y = y-50;
		move=false;
	...
	public void paint(Graphics g)
	{
		...
		if(move) 
			...
			more=-2;
		int vestido_posix=posi_x+128+more;
		for(int i=0;i<15;i++)
		{
			if(i%2==0)
		...
		g.fillRect(posi_x+130+more, posi_y+273, 150, 5);
	}
