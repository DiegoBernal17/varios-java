...
public class Practica1 extends Applet implements ItemListener {
	...
	public void init()
	{
		Label lb = new Label("Selecciona el color de piel: ");
		add(lb);
		CheckboxGroup cbg = new CheckboxGroup();
		c1 = new Checkbox("Amarillo",cbg,true);
		c2 = new Checkbox("Azul",cbg,false);
		c3 = new Checkbox("Verde",cbg,false);
